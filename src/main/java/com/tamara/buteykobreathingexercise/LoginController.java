...
public class LoginController implements Initializable {
    ...
    private void loginAction(ActionEvent event) throws IOException {
        ...
        if (validateLogin(userName, passWord)) {
            ...
            Alert alert = new Alert(AlertType.INFORMATION, "Login Success as " + userName, ButtonType.OK);
            ...
            Alert alert = new Alert(AlertType.ERROR, "Invalid Credentials", ButtonType.OK);
            alert.show();
        }
